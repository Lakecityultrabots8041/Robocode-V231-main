 ...
 */
public class MoveElevatorDownFast_cmd extends Command {
    private final Elevator_Subsystem elevator;
    private final double speed;

    
    public MoveElevatorDownFast_cmd(Elevator_Subsystem elevator, double speed) {
